...
for year in range(BASE_YEAR, END_YEAR+1):
    ...
    #CALCUALTE TRAVEL KM PER STOCK AND THEN DOUBLE CHECK IT IS THE SAME AS THE TRAVEL KM PER STOCK IN THE MAIN DATAFRAME
    change_dataframe['Travel_km_per_stock'] = change_dataframe['Travel_km'] / change_dataframe['Stocks']
    ...
    change_dataframe['Stocks_after_turnover_and_surplus'] = change_dataframe['Stocks'] - change_dataframe['Stock_turnover'] + change_dataframe['Surplus_stocks']

    #CALCUALTE NEW STOCKS NEEDED AS NEW STOCKS NEEDED MINUS STOCKS AFTER TURNOVER AND SURPLUS
    change_dataframe['New_stocks_needed'] = change_dataframe['Stocks_needed'] - change_dataframe['Stocks_after_turnover_and_surplus']
    ...
    change_dataframe['Efficiency'] = (change_dataframe['New_stocks_needed'] * change_dataframe['New_vehicle_efficiency'] + change_dataframe['Stocks_after_turnover_and_surplus'] * change_dataframe['Efficiency']) / (change_dataframe['Stocks_after_turnover_and_surplus'] + change_dataframe['New_stocks_needed'])
...
#somehow we are getting cols for Unnamed: 0_y an such
#seems like teh adjsutments data is not merging proerply or doesnt have enough combinations as it is merging to become nA.

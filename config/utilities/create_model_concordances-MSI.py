...
model_concordances.to_csv('config/concordances/model_concordances_{}.csv'.format(datetime.datetime.now().strftime("%Y%m%d")), index=False)
...
#save
model_concordances_fuels.to_csv('config/concordances/model_concordances_fuels_{}.csv'.format(datetime.datetime.now().strftime("%Y%m%d")), index=False)
model_concordances_fuels_NO_BIOFUELS.to_csv('config/concordances/model_concordances_fuels_NO_BIOFUELS_{}.csv'.format(datetime.datetime.now().strftime("%Y%m%d")), index=False)
#%%

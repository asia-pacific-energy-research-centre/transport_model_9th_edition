...
def main():
    ...
    if MODEL_RUN_1:
        ...
        run_non_road_model.run_non_road_model(OUTLOOK_BASE_YEAR,END_YEAR,BASE_YEAR, PROJECT_TO_JUST_OUTLOOK_BASE_YEAR=PROJECT_TO_JUST_OUTLOOK_BASE_YEAR)
    ...
    if MODEL_RUN_2:
        ...
        run_non_road_model.run_non_road_model(OUTLOOK_BASE_YEAR,END_YEAR,BASE_YEAR, ADVANCE_BASE_YEAR=ADVANCE_BASE_YEAR)

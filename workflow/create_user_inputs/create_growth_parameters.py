...
macro['gdp_times_capita_growth'] = macro.groupby('economy')['gdp_times_capita'].pct_change()
macro['gdp_growth'] = macro.groupby('economy')['gdp'].pct_change()
macro['population_growth'] = macro.groupby('economy')['population'].pct_change()
macro['gdp_per_capita_growth'] = macro.groupby('economy')['gdp_per_capita'].pct_change()
#remove na rows
macro = macro.dropna()
...
#%%
#lets try using machine learning methods. THese canrpovide generally better performance than linear regression how eever it will be important to analyse the results jsut in case:

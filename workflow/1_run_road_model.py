...
Vehicle_sales_share = road_model_input[['Economy','Scenario', 'Drive', 'Vehicle Type', 'Transport Type', 'Year', 'Vehicle_sales_share']].drop_duplicates()
Occupancy_or_load_growth = road_model_input[['Economy','Scenario', 'Drive','Vehicle Type', 'Transport Type', 'Year', 'Occupancy_or_load_growth']].drop_duplicates()
Turnover_rate_growth = road_model_input[['Economy','Scenario','Vehicle Type', 'Transport Type', 'Drive', 'Year', 'Turnover_rate_growth']].drop_duplicates()
# Activity_growth = road_model_input[['Economy','Scenario', 'Year', 'Activity_growth']].drop_duplicates()
New_vehicle_efficiency_growth = road_model_input[['Economy','Scenario', 
'Vehicle Type', 'Transport Type', 'Drive', 'Year', 'New_vehicle_efficiency_growth']].drop_duplicates()
...
for year in range(BASE_YEAR+1, END_YEAR+1):
    ...
    change_dataframe = change_dataframe.merge(Occupancy_or_load_growth, on=['Economy','Scenario','Drive','Vehicle Type', 'Transport Type', 'Year'], how='left')

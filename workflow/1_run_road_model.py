...
for year in range(BASE_YEAR+1, END_YEAR+1):
    ...
    addition_to_main_dataframe = addition_to_main_dataframe[['Economy', 'Scenario', 'Transport Type', 'Vehicle Type', 'Date', 'Drive', 'Activity', 'Stocks', 'Efficiency', 'Energy', 'Surplus_stocks', 'Travel_km', 'Mileage', 'Vehicle_sales_share', 'Occupancy_or_load', 'Turnover_rate', 'New_vehicle_efficiency']]
...
# change_dataframe['Occupancy_or_load'] = change_dataframe['Occupancy_or_load'] * change_dataframe['Load_growth']
...
# change_dataframe = change_dataframe.loc[change_dataframe['Transport Type'] == 'freight',:]
...
# #CALCUALTE ACTIVITY WORTH OF STOCK TURNOVER AND SURPLUS
# passenger_change_dataframe['Activity_worth_of_stock_turnover_and_surplus'] = passenger_change_dataframe['Stock_turnover_and_surplus_total'] * passenger_change_dataframe['Mileage'] * passenger_change_dataframe['Occupancy']
...
# #Activity worth of stocks after turnover and surplus total
# passenger_change_dataframe['Activity_worth_of_stocks_after_turnover_and_surplus_total'] = passenger_change_dataframe['Stocks_after_turnover_and_surplus_total'] * passenger_change_dataframe['Mileage'] * passenger_change_dataframe['Occupancy']
...
# #CALCUALTE STOCKS BEING USED
# #Note that this is the new level of stocks in the economy
# passenger_change_dataframe['Stocks'] = passenger_change_dataframe['Travel_km'] / passenger_change_dataframe['Mileage']

# #CALCUALTE NEW STOCKS NEEDED AS STOCKS NEEDED TO SATISFY NEW SALES WORTH OF ACTIVITY
# passenger_change_dataframe['New_stocks_needed'] = passenger_change_dataframe['Travel_km_of_new_stocks'] / passenger_change_dataframe['Mileage']

# #CALCUALTE SURPLUS STOCKS
# #If we have too many stocks these go into surplus
# passenger_change_dataframe['Surplus_stocks'] = passenger_change_dataframe['Travel_km_of_surplus_stocks'] / passenger_change_dataframe['Mileage']
...
# change_dataframe = pd.concat([passenger_change_dataframe, change_dataframe])

# #Now start cleaning up the changes dataframe to create the dataframe for the new year.
# addition_to_main_dataframe = change_dataframe.copy() 

# addition_to_main_dataframe = addition_to_main_dataframe[['Economy', 'Scenario', 'Transport Type', 'Vehicle Type', 'Date', 'Drive', 'Activity','passenger_km', 'Stocks', 'Efficiency', 'Energy', 'Surplus_stocks', 'Travel_km', 'Mileage', 'Vehicle_sales_share', 'Occupancy','Occupancy_or_load', 'Turnover_rate', 'New_vehicle_efficiency']]

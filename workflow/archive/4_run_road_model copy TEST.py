...
print('2.  There are ', sum(change_dataframe.isna().sum()), 'NANs in the Input Activity Ratio dataframe. These are in the following columns:', pd.isnull(change_dataframe).sum()[pd.isnull(change_dataframe).sum() > 0], ' \n We will delte these by default. Take a look if you think it seems suspect\n\n')
...
change_dataframe = change_dataframe.merge(OccupanceAndLoad_growth, on=['Economy', 'Vehicle Type', 'Transport Type', 'Scenario', 'Year'], how='left')
...
#search fr any NANs, print them out in case they are important, but by default drop them
print('3.  There are ', sum(change_dataframe.isna().sum()), 'NANs in the Input Activity Ratio dataframe. These are in the following columns:', pd.isnull(change_dataframe).sum()[pd.isnull(change_dataframe).sum() > 0], ' \n We will delte these by default. Take a look if you think it seems suspect\n\n')
...
#search fr any NANs, print them out in case they are important, but by default drop them
print('4  There are ', sum(change_dataframe.isna().sum()), 'NANs in the Input Activity Ratio dataframe. These are in the following columns:', pd.isnull(change_dataframe).sum()[pd.isnull(change_dataframe).sum() > 0], ' \n We will delte these by default. Take a look if you think it seems suspect\n\n')
...
#search fr any NANs, print them out in case they are important, but by default drop them
print('5   There are ', sum(change_dataframe.isna().sum()), 'NANs in the Input Activity Ratio dataframe. These are in the following columns:', pd.isnull(change_dataframe).sum()[pd.isnull(change_dataframe).sum() > 0], ' \n We will delte these by default. Take a look if you think it seems suspect\n\n')

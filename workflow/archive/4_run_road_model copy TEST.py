...
#NOTE that there is still the fuel mixing operation that is not in this file of code. 
#filter for only australian economy and passenger transport
change_dataframe = change_dataframe.loc[(change_dataframe.Economy == '01_AUS') & (change_dataframe['Transport Type'] == 'passenger'),:]
#%%
#######################################################################
...
if change_dataframe['Turnover_rate'].max() > 1:
    print('ERROR: Turnover rate is greater than 1. This is not possible. Please check the Turnover rate growth data.')
    # break

...
#make wide
regression_based_growth_estimates = regression_based_growth_estimates.pivot(index=['Economy', 'Date'], columns='Measure', values='Value').reset_index()
...
regression_based_growth_estimates_long = pd.melt(regression_based_growth_estimates, id_vars=['Economy', 'Date'], value_vars=['Activity_growth_8th_index', 'Activity_growth_est_index', 'Energy_growth_est_index', 'Gdp_times_capita_growth_index', 'Gdp_per_capita_growth_index'], var_name='Variable', value_name='Value')

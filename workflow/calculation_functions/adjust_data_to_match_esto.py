...
def adjust_data_to_match_esto(BASE_YEAR, ECONOMY_ID, road_model_input_wide,non_road_model_input_wide,supply_side_fuel_mixing,  TESTING=False):
    ...
    test_output_matches_expectations(supply_side_fuel_mixing, road_all_wide, non_road_all_wide, energy_use_merged, BASE_YEAR,  ADVANCE_BASE_YEAR=True)
...
def format_energy_use_for_rescaling(energy_use_esto, energy_use_output, spread_non_specified_and_separate_pipeline = True, remove_annoying_fuels = True):
...
#############
def adjust_energy_use_in_input_data(supply_side_fuel_mixing, input_data_based_on_previous_model_run,energy_use_merged,road_model_input_wide,non_road_model_input_wide,energy_use_output):
    #CLEAN INPUT DATA 

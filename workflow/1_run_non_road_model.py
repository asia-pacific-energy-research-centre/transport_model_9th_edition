...
non_road_efficiency_growth = non_road_model_input[['Economy', 'Scenario', 'Transport Type', 'Drive', 'Medium', 'Vehicle Type', 'Year','Non_road_efficiency_growth']].drop_duplicates()

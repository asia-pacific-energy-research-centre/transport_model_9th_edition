...
def create_supply_side_fuel_mixing_input():
    ...
    #save previous datra
    shutil.copy('intermediate_data/aggregated_model_inputs/{}_supply_side_fuel_mixing.csv'.format(FILE_DATE_ID), archiving_folder + '/{}_supply_side_fuel_mixing.csv'.format(FILE_DATE_ID))

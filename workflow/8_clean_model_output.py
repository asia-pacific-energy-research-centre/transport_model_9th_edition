...
model_output_non_detailed = model_output_all.copy().loc[:, ['Year', 'Economy', 'Scenario', 'Transport Type', 'Vehicle Type', 'Drive', 'Medium','Stocks', 'Activity', 'Energy']]
...
model_output_all_with_fuels = model_output_all_with_fuels.loc[:, ['Year', 'Economy', 'Scenario', 'Transport Type', 'Vehicle Type', 'Drive', 'Medium', 'Fuel',  'Energy']]
#%%
#save data

...
#filter out data after 2060
all_data = all_data[all_data['Date']<=2070]
                ...
                for emissions_divisia in emissions_divisia_list:
                    ...
                    for hierarchical in hierarchical_list:
                        ...
                        for economy in economy_list:
                            extra_identifier = '{}_{}_{}_{}_{}_{}_{}'.format(economy,scenario, transport_type, medium, len(structure_variables),emissions_string, hierarchical_string)
                            graph_title = '{} {} {} - Drivers of changes in {} ({}) - {} LMDI'.format(economy, medium, transport_type,emissions_string, scenario, hierarchical_string)

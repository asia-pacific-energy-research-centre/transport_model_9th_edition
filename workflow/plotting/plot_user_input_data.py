...
def plot_new_sales_shares(new_sales_shares_all, new_sales_shares_sum):
    ...
    new_sales_shares_all_plot.to_csv(f'output_data/assumptions_outputs/vehicle_sales_shares{FILE_DATE_ID}.csv')

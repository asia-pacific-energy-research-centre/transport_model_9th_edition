...
supply_side_fuel_mixing_diesel = supply_side_fuel_mixing.loc[(supply_side_fuel_mixing['Fuel'] == '7_7_gas_diesel_oil')]
supply_side_fuel_mixing_diesel['16_6_biodiesel'] = 0.05
supply_side_fuel_mixing_diesel['7_7_gas_diesel_oil'] = 0.95
...
supply_side_fuel_mixing_petrol = supply_side_fuel_mixing.loc[(supply_side_fuel_mixing['Fuel'] == '7_1_motor_gasoline')]
supply_side_fuel_mixing_petrol['16_5_biogasoline'] = 0.05
supply_side_fuel_mixing_petrol['7_1_motor_gasoline'] = 0.95
#now melt so we have a tall dataframe
...
supply_side_fuel_mixing_jet_fuel = supply_side_fuel_mixing.loc[(supply_side_fuel_mixing['Fuel'] == '7_x_jet_fuel')]
supply_side_fuel_mixing_jet_fuel['16_7_bio_jet_kerosene'] = 0.05
supply_side_fuel_mixing_jet_fuel['7_x_jet_fuel'] = 0.95
#now melt so we have a tall dataframe
...
supply_side_fuel_mixing_avgas = supply_side_fuel_mixing.loc[(supply_side_fuel_mixing['Fuel'] == '7_2_aviation_gasoline')]
supply_side_fuel_mixing_avgas['16_7_bio_jet_kerosene'] = 0.05
supply_side_fuel_mixing_avgas['7_2_aviation_gasoline'] = 0.95
#now melt so we have a tall dataframe
